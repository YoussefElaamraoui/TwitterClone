  ...
  <div class="about">
    <div id="thread">
      ...
      <p id="thread__text">
        ...
        urna. Aliquam sit amet sagittis enim. Nam non elit nulla. Donec vel nibh arcu. Proin congue odio et vestibulum
      ...
      <div id="comment">
        ...
        <div v-if="posts.comments && posts.comments.length > 0" class="comment__user" v-for="post in posts.comments" :key="post.comments">
          <div>
